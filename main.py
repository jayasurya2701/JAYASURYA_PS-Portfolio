...
if page == "🏠 Home":
    ...
    file_id = "1cq2c-gH4nrd-Aj72mLibxWuIGNv-0pDs"
    ...
    st.header("🚀 Projects")
    projects = {
        "Web Research Agent": ["Web Research Agent is an intelligent, AI-powered research automation tool designed for analysts, writers, students, and professionals to streamline online research workflows. Built with SerpAPI, Groq API, and advanced web scraping techniques, this tool automates multi-source search, structured data extraction, and real-time report generation—minimizing human input. Integrated with Groq LLMs for enhanced summarization, topic clustering, and relevance scoring, it delivers fast, accurate, and insightful content across diverse domains.","https://github.com/jayasurya2701/Web_Research_Agent"],
        ...
        "SpendEase-Daily Expense Tracker": ["SpendEase is a daily expense tracker designed to help individuals efficiently record, manage, and analyze their spending habits. With real-time budget tracking, insightful analytics, and seamless data management, SpendEase empowers users to stay financially disciplined and make smarter financial decisions.Built with Streamlit and Pandas, SpendEase offers real-time budget tracking, dynamic visualizations, and seamless data management for an effortless expense-tracking experience. With intuitive insights, SpendEase empowers users to track, save, and succeed with ease.", "https://github.com/jayasurya2701/SpendEase-Daily_Expense_Tracker"],
