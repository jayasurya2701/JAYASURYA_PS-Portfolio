...
if page == "🏠 Home":
    ...
    file_id = "1paPH72eLRE8A842bWw1wQv0m0DE3Iway"
    ...
    projects = {
        ...
        "Face-Detection-and-Recognition-Model-using-Python-and-OpenCV": ["This project involves the development of a robust Face Detection and Recognition Model using Python and OpenCV. It leverages computer vision techniques and machine learning to identify and verify individuals based on their facial features. The application can be used in various domains such as security systems, attendance monitoring, and user authentication.", "https://github.com/jayasurya2701/Face-Detection-and-Recognition-Model-using-Python-and-OpenCV"],
